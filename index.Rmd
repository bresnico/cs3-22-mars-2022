...
Chères et Cher Membres du Comité scientifique (de la formation continue obligatoire des ES du VS Romand),
 
Comme convenu, veuillez trouver ci-dessous le lien vers un Doodle permettant l'organisation d'une séance à la mi-mars. Cette séance aura pour but de :
- figer l'essentiel des contenus de formation dans chacun des 4 thèmes
- déterminer les équipes de formation à mobiliser pour toute la formation 2022-2024
 
Cette séance s'inscrit dans un calendrier qui nous impose de réserver les équipes de formation vers la fin mars dans le cas où la formation peut démarrer en août 2022 comme prévu. Je vous rappelle que le feu vert financier est attendu à la fin mars.
 
Voici le lien pour participer au Doodle : https://doodle.com/poll/a2sbyw5n5gz8e4uf
 
Comme d'habitude, en tant que membre du comité de pilotage et si le procédé vous convient toujours, je me mets à disposition pour organiser et prendre le PV de la rencontre.
 
En ce sens, l'ordre du jour proposé est le suivant :
1- accueil
2- état des lieux général (Nicolas)
3- définition des contenus dans chacun des 4 thèmes (membres du comité scientifique)
4- répartition des missions pour recruter les équipes de formation (membres du comité scientifique)
5- clarification des prochaines échéances (Nicolas)
6- divers
